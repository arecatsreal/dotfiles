 ...
 */
static char *font = "Anonymice Nerd Font:pixelsize=60:antialias=true:autohint=true";
static char *font2[] = { "Anonymice Nerd Font:pixelsize=60:antialias=true:autohint=true" };
