palette = {
    ...
    'background-attention': '#161320', # Black zero
    'border': '#C9CBFF',
    'current-line': '#302D41',
    'selection': '#575268',
    'foreground': '#D9E0EE',
    'foreground-alt': '#C9CBFF',
    'foreground-attention': '#F5E0DC',
    'comment': '#6E6C7E',
    'flamingo': '#F2CDCD',
    'mauve': '#DDB6F2',
    'pink': '#F5C2E7',
...
c.colors.completion.match.fg = palette['maroon']

## Color of the scrollbar in completion view
c.colors.completion.scrollbar.bg = palette['background']

## Color of the scrollbar handle in completion view.
c.colors.completion.scrollbar.fg = palette['teal']
...
c.colors.hints.fg = palette['mauve']
...
c.colors.keyhint.fg = palette['mauve']
...
c.colors.prompts.fg = palette['sky']
...
## Type: QtColor
#c.colors.tabs.bar.fg = palette['pink']
...
## Type: QtColor
c.colors.tabs.indicator.start = palette['peach']
